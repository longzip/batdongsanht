...
import {SHOP_NAME, FB_PAGE_URL} from "../../lib/constants"
	...
	return (
		<nav className="bg-white p-4">
			<div className="flex items-center justify-between flex-wrap container mx-auto">
				...
				<div className="h-8 w-8 self-center mr-2">
					<img className="h-8 w-8 self-center" src="/logo-0.png" />
				</div>
				...
				<div className={`${ isMenuVisible ? 'max-h-full h-full' : 'h-0' } w-full overflow-hidden lg:h-full flex-grow lg:flex lg:items-center lg:w-auto`}>
					...
					<Link href={`${FB_PAGE_URL}about/`}>
						<a className="block mt-4 lg:inline-block lg:mt-0 text-black hover:text-black mr-10">
							Giới thiệu
						</a>
					</Link>
					<Link href="http://blog.batdongsanht.ga">
						<a className="block mt-4 lg:inline-block lg:mt-0 text-black hover:text-black mr-10">
							Tin tức
						</a>
					</Link>
					<Link href={`${FB_PAGE_URL}reviews/`}>
						<a className="block mt-4 lg:inline-block lg:mt-0 text-black hover:text-black mr-10">
							Đánh giá
						</a>
					</Link>
					<Link href={`${FB_PAGE_URL}events/`}>
						<a className="block mt-4 lg:inline-block lg:mt-0 text-black hover:text-black mr-10">
							Sự kiện
						</a>
					</Link>
					<Link href={`${FB_PAGE_URL}offers/`}>
						<a className="block mt-4 lg:inline-block lg:mt-0 text-black hover:text-black mr-10">
							Ưu đãi
						</a>
					</Link>
